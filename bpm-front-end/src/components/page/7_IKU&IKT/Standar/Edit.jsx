  ...
  useEffect(() => {
    const fetchStandar = async () => {
      ...
      if (result === "ERROR") {
        ...
        namaStaRef.current = obj.judulSta;
        jenisStaRef.current = obj.jenisSta;
        tahunStaRef.current = obj.tahunSta;
        urutanStaRef.current = obj.urutanSta;
        parentStaRef.current = obj.parentIdSta;
        if (obj.parentIdSta) setIsChecked(true);
      }
    };
